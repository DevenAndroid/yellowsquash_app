            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(6), color: const Color(0xffF8F8F8)),
                  child: Padding(
    ...
    return Column(
      ...
      children: [
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 14, fontWeight: FontWeight.w400, color: AppTheme.headlineColor, fontStyle: FontStyle.italic),
                ),
              ],
            ),
          ),
        ...
        const Text(
          ...
          style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: AppTheme.subTitleColor, fontStyle: FontStyle.normal),
        ),
        const SizedBox(height: 10),
        const Text(
          "What is Keto Diet?",
        ...
        Container(
          ...
          child: ElevatedButton(
            ...
            child: const Center(
                child: Text("Post", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16, color: AppTheme.blackcolor))),
          ),
        ),
      ],
    );
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Icon(Icons.thumb_up_off_alt,size: 15,color: Colors.grey,),
                              Text(
                                " 2   Reply",
                                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: AppTheme.subTitleColor),
                              ),
