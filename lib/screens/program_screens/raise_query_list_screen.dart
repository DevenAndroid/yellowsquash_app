        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text(
                "I have a query.Dignissim orci vulputate varius sapien. Sed sed dui scelerisque massa tristique purus, egestas congue. Dignissim non feugiat bibendum suspendisse. Dolor consequat senectus turpis dui. Diam morbi faucibus sit massa?",
                style: TextStyle(color: AppTheme.blackcolor, fontSize: 16, fontWeight: FontWeight.w400),
              ),
              const SizedBox(height: 10),
              answers()
            ],
